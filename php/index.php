...
<div><strong>24/7</strong><br>Support étudiant</div>
      ...
      <div class="container carousel-container" style="margin-bottom: 0px;">        
        <div id="carouselLogements" class="carousel slide" data-bs-ride="carousel">
            <!-- Indicateurs -->
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselLogements" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Précédent</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselLogements" data-bs-slide="next">
